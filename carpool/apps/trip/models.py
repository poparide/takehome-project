...
class Trip(models.Model):
    ...
    origin = models.ForeignKey("location.Location", on_delete=models.PROTECT, related_name='trips_from')
    destination = models.ForeignKey("location.Location", on_delete=models.PROTECT, related_name='trips_to')
